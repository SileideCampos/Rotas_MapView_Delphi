...
uses
  ...
  FMX.Objects, FMX.Ani, System.Threading, ControleEspera, uFunctions,
...
type
  TF_BuscaRotas = class(TForm)
    ...
    procedure mDestinosClick(Sender: TObject);
  private
...
begin
  ...
  begin
    DM.GeraAtributoRota;
    mDestinos.Lines.Add(DM.FEstimativaRota);
    mDestinos.Lines.Add('');
    mDestinos.Lines.Add(DM.FDescricaoRotas);
...
procedure TF_BuscaRotas.mDestinosClick(Sender: TObject);
begin
